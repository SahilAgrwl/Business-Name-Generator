...
export const metadata = {
  ...
  description: 'Generate unique and creative business names with AI',
}
    ...
    <html lang="en">
      <body className="bg-gradient-to-br from-gray-50 to-gray-100">
        <div className="min-h-screen flex flex-col">
          ...
          <main className="max-w-5xl mx-auto px-6 py-10 w-full flex-grow">
            {children}
          </main>
          <footer className="mt-auto py-8 bg-gray-800 text-white">
            <div className="max-w-5xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between">
              <div className="text-center md:text-left mb-4 md:mb-0">
                © {new Date().getFullYear()} Business Name Generator. All rights reserved.
              </div>
